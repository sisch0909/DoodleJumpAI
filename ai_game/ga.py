...
class GeneticAlgorithm():
    ...
    # Populate depending on wether there is already a best brain or wether there is none (for example in the first generation)
    ...
    def nextGeneration(self, total, array):
        ...
        champion = self.best.clone() # Clone the champion of the previos generation
        self.populate(1, champion.brain) # Populate the current generation with it's brain
